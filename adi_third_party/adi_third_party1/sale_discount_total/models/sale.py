...
class SaleOrder(models.Model):
    ...
    discount_type = fields.Selection([('percent', 'Pourcentage'), ('amount', 'Montant')], string='Type de remise',
                                     ...
                                     default='percent')
    discount_rate = fields.Float('Pourcentage remise', digits=dp.get_precision('Account'),
    ...
    amount_total = fields.Monetary(string='Total', store=True, readonly=True, compute='_amount_all',
                                   track_visibility='always')
    amount_discount = fields.Monetary(string='Remise', store=True, readonly=True, compute='_amount_all',
